...
{
  var i = m$2.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
  client.createRoot = function(c, o) {
    i.usingClientEntryPoint = true;
    try {
      return m$2.createRoot(c, o);
    } finally {
...
const Signup = () => {
  ...
  return /* @__PURE__ */ React$1.createElement(StyledWrapper, null, /* @__PURE__ */ React$1.createElement("div", { className: "container" }, /* @__PURE__ */ React$1.createElement("input", { type: "checkbox", id: "register_toggle" }), /* @__PURE__ */ React$1.createElement("div", { className: "slider" }, /* @__PURE__ */ React$1.createElement("form", { className: "form" }, /* @__PURE__ */ React$1.createElement("span", { className: "title" }, "Sign Up"), /* @__PURE__ */ React$1.createElement("div", { className: "form_control" }, /* @__PURE__ */ React$1.createElement("input", { type: "text", className: "input", required: true, name: "name", onChange: handleChange }), /* @__PURE__ */ React$1.createElement("label", { className: "label" }, "Username")), /* @__PURE__ */ React$1.createElement("div", { className: "form_control" }, /* @__PURE__ */ React$1.createElement("input", { type: "email", className: "input", required: true, name: "email", onChange: handleChange }), /* @__PURE__ */ React$1.createElement("label", { className: "label" }, "Email")), /* @__PURE__ */ React$1.createElement("div", { className: "form_control" }, /* @__PURE__ */ React$1.createElement("input", { type: "password", className: "input", name: "password", onChange: handleChange, required: true }), /* @__PURE__ */ React$1.createElement("label", { className: "label" }, "Password")), /* @__PURE__ */ React$1.createElement("button", null, "Sign Up"), /* @__PURE__ */ React$1.createElement("span", { className: "bottom_text" }, "Already have an account? ", /* @__PURE__ */ React$1.createElement("label", { htmlFor: "register_toggle", className: "swtich" }, "Sign In"), " ")))));
};
