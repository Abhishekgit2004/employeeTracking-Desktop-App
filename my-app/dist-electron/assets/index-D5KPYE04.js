 ...
 */
{
  (function() {
    ...
    function isValidContainer(node2) {
      return !!(node2 && (node2.nodeType === ELEMENT_NODE || node2.nodeType === DOCUMENT_NODE || node2.nodeType === DOCUMENT_FRAGMENT_NODE || false));
    }
...
var f = "undefined" != typeof process && void 0 !== process.env && (process.env.REACT_APP_SC_ATTR || process.env.SC_ATTR) || "data-styled", m = "active", y = "data-styled-version", v = "6.1.19", g = "/*!sc*/\n", S = "undefined" != typeof window && "undefined" != typeof document, w = Boolean("boolean" == typeof SC_DISABLE_SPEEDY ? SC_DISABLE_SPEEDY : "undefined" != typeof process && void 0 !== process.env && void 0 !== process.env.REACT_APP_SC_DISABLE_SPEEDY && "" !== process.env.REACT_APP_SC_DISABLE_SPEEDY ? "false" !== process.env.REACT_APP_SC_DISABLE_SPEEDY && process.env.REACT_APP_SC_DISABLE_SPEEDY : "undefined" != typeof process && void 0 !== process.env && void 0 !== process.env.SC_DISABLE_SPEEDY && "" !== process.env.SC_DISABLE_SPEEDY ? "false" !== process.env.SC_DISABLE_SPEEDY && process.env.SC_DISABLE_SPEEDY : true), E = /invalid hook call/i, N = /* @__PURE__ */ new Set(), P = function(t2, n2) {
  {
    ...
    try {
      ...
      }, reactExports.useRef(), a2 && !N.has(s2) && (console.warn(s2), N.add(s2));
    } catch (e2) {
...
var ze = new ke(), Me = Fe(), $e = React$1.createContext({ shouldForwardProp: void 0, styleSheet: ze, stylis: Me });
$e.Consumer;
...
function Xe(e2, t2, n2, o2) {
  ...
  if (re(e2)) {
    ...
    var r2 = e2(t2);
    return "object" != typeof r2 || Array.isArray(r2) || r2 instanceof qe || ce(r2) || null === r2 || console.error("".concat(B(e2), " is not a styled component and cannot be referred to via component selector. See https://www.styled-components.com/docs/advanced#referring-to-other-components for more details.")), Xe(r2, t2, n2, o2);
  }
  var s2;
  return e2 instanceof qe ? n2 ? (e2.inject(n2, o2), [e2.getName(o2)]) : [e2] : ce(e2) ? Je(e2) : Array.isArray(e2) ? Array.prototype.concat.apply(_, e2.map(function(e3) {
    return Xe(e3, t2, n2, o2);
  })) : [e2.toString()];
}
var Ke = M(v), Qe = function() {
  function e2(e3, t2, n2) {
    this.rules = e3, this.staticRulesId = "", this.isStatic = false, this.componentId = t2, this.baseHash = z(Ke, t2), this.baseStyle = n2, ke.registerId(t2);
  }
  return e2.prototype.generateAndInjectStyles = function(e3, t2, n2) {
    ...
    if (this.isStatic && !n2.hash) if (this.staticRulesId && t2.hasNameForId(this.componentId, this.staticRulesId)) o2 = ie(o2, this.staticRulesId);
      ...
      var r2 = ae(Xe(this.rules, e3, t2, n2)), s2 = x(z(this.baseHash, r2) >>> 0);
      ...
      for (var a2 = z(this.baseHash, n2.hash), c2 = "", l2 = 0; l2 < this.rules.length; l2++) {
        var u2 = this.rules[l2];
        if ("string" == typeof u2) c2 += u2, a2 = z(a2, u2);
        else if (u2) {
...
function it(e2, r2, s2) {
  var i2 = se(e2), a2 = e2, c2 = !G(e2), p2 = r2.attrs, d2 = void 0 === p2 ? _ : p2, h2 = r2.componentId, f2 = void 0 === h2 ? function(e3, t2) {
  ...
  function O2(e3, r3) {
    return function(e4, r4, s3) {
      var i3 = e4.attrs, a3 = e4.componentStyle, c3 = e4.defaultProps, p3 = e4.foldedComponentIds, d3 = e4.styledComponentId, h3 = e4.target, f3 = React$1.useContext(et), m3 = Le(), y3 = e4.shouldForwardProp || m3.shouldForwardProp;
      reactExports.useDebugValue(d3);
      ...
      var E3 = function(e5, t2) {
        ...
        return reactExports.useDebugValue(o2), o2;
      }(a3, g3);
      e4.warnTooManyClasses && e4.warnTooManyClasses(E3);
      var N3 = ie(p3, d3);
      return E3 && (N3 += " " + E3), g3.className && (N3 += " " + g3.className), w3[G(S3) && !A.has(S3) ? "class" : "className"] = N3, s3 && (w3.ref = s3), reactExports.createElement(S3, w3);
    }(D2, e3, r3);
  }
  O2.displayName = y2;
...
const Signup = () => {
  return /* @__PURE__ */ React$1.createElement(StyledWrapper, null, /* @__PURE__ */ React$1.createElement("div", { className: "container" }, /* @__PURE__ */ React$1.createElement("input", { type: "checkbox", id: "register_toggle" }), /* @__PURE__ */ React$1.createElement("div", { className: "slider" }, /* @__PURE__ */ React$1.createElement("form", { className: "form" }, /* @__PURE__ */ React$1.createElement("span", { className: "title" }, "Login"), /* @__PURE__ */ React$1.createElement("div", { className: "form_control" }, /* @__PURE__ */ React$1.createElement("input", { type: "text", className: "input", required: true }), /* @__PURE__ */ React$1.createElement("label", { className: "label" }, "Username")), /* @__PURE__ */ React$1.createElement("div", { className: "form_control" }, /* @__PURE__ */ React$1.createElement("input", { type: "password", className: "input", required: true }), /* @__PURE__ */ React$1.createElement("label", { className: "label" }, "Password")), /* @__PURE__ */ React$1.createElement("button", null, "Login"), /* @__PURE__ */ React$1.createElement("span", { className: "bottom_text" }, "Don't have an account? ", /* @__PURE__ */ React$1.createElement("label", { htmlFor: "register_toggle", className: "swtich" }, "Sign Up"), " ")), /* @__PURE__ */ React$1.createElement("form", { className: "form" }, /* @__PURE__ */ React$1.createElement("span", { className: "title" }, "Sign Up"), /* @__PURE__ */ React$1.createElement("div", { className: "form_control" }, /* @__PURE__ */ React$1.createElement("input", { type: "text", className: "input", required: true }), /* @__PURE__ */ React$1.createElement("label", { className: "label" }, "Username")), /* @__PURE__ */ React$1.createElement("div", { className: "form_control" }, /* @__PURE__ */ React$1.createElement("input", { type: "email", className: "input", required: true }), /* @__PURE__ */ React$1.createElement("label", { className: "label" }, "Email")), /* @__PURE__ */ React$1.createElement("div", { className: "form_control" }, /* @__PURE__ */ React$1.createElement("input", { type: "password", className: "input", required: true }), /* @__PURE__ */ React$1.createElement("label", { className: "label" }, "Password")), /* @__PURE__ */ React$1.createElement("button", null, "Sign Up"), /* @__PURE__ */ React$1.createElement("span", { className: "bottom_text" }, "Already have an account? ", /* @__PURE__ */ React$1.createElement("label", { htmlFor: "register_toggle", className: "swtich" }, "Sign In"), " ")))));
};
...
function App() {
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Signup, null));
}
