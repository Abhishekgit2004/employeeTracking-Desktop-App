...
function App() {
  const [app, setApp] = reactExports.useState({ name: "e", title: "" });
  reactExports.useEffect(() => {
    const interval = setInterval(async () => {
      const active = await window.api.getActiveApp();
      if (active) setApp(active);
    }, 1e4);
    return () => clearInterval(interval);
  }, []);
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h2", null, "Active App:"), /* @__PURE__ */ React.createElement("p", null, "Name: ", app.name), /* @__PURE__ */ React.createElement("p", null, "Window Title: ", app.title));
}
