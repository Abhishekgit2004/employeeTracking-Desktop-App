...
function ActiveApp() {
  ...
  reactExports.useEffect(() => {
    const interval = setInterval(async () => {
      const response = await fetch("/get-active-app");
      const data = await response.json();
      setActiveApp(data.appName);
    }, 1e3);
    return () => clearInterval(interval);
  }, []);
  return /* @__PURE__ */ React.createElement("div", null, "Current Active App: ", activeApp);
}
client.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ React.createElement(React.StrictMode, null, /* @__PURE__ */ React.createElement(ActiveApp, null))
);
