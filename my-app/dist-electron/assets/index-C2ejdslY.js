...
function App() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    window.api.login(payload).then((msg) => {
      console.log(payload);
    });
  };
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("form", { action: "", className: "text-white", onSubmit: handleSubmit }, /* @__PURE__ */ React.createElement("label", { htmlFor: "fname", className: "text-black" }, "First naddme:"), /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("input", { type: "text", id: "fname", name: "name", onChange: handleChange }), /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("label", { htmlFor: "lname", type: "email" }, "email"), /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("input", { type: "text", id: "lname", name: "email", onChange: handleChange }), /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("label", { htmlFor: "lname", type: "password" }, "pasword"), /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("input", { type: "text", id: "lname", name: "password", onChange: handleChange }), /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("button", { type: "submit", className: "bg-red" }, "submit")), /* @__PURE__ */ React.createElement("h1", null, "hello")));
}
