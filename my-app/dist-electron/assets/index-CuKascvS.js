...
function App() {
  ...
  const [usageTime, setUsageTime] = reactExports.useState(0);
  reactExports.useEffect(() => {
    var _a;
    if ((_a = window.electronAPI) == null ? void 0 : _a.onActiveAppChange) {
      window.electronAPI.onActiveAppChange(({ appName, usageTime: usageTime2 }) => {
        setActiveApp(appName);
        setUsageTime(Math.round(usageTime2 / 1e3));
      });
    }
  }, []);
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("table", { style: { border: "2px solid black", padding: 2, display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column" } }, /* @__PURE__ */ React.createElement("th", { style: { border: "2px solid black" } }, /* @__PURE__ */ React.createElement("td", null, "App Name"), /* @__PURE__ */ React.createElement("td", null, "Usage Time")), /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("td", { style: { border: "2px solid black" } }, activeApp), /* @__PURE__ */ React.createElement("td", { style: { border: "2px solid black" } }, usageTime, " seconds"))), /* @__PURE__ */ React.createElement("h1", null, "Current Active App: ", activeApp), /* @__PURE__ */ React.createElement("p", null, "Usage Time: ", usageTime, " seconds"));
}
