...
function App() {
  const [appLogs, setAppLogs] = reactExports.useState({});
  reactExports.useEffect(() => {
    var _a;
    if ((_a = window.electronAPI) == null ? void 0 : _a.onActiveAppChange) {
      window.electronAPI.onActiveAppChange(({ appName, usageTime }) => {
        setAppLogs((prevLogs) => {
          var _a2;
          const prevUsage = ((_a2 = prevLogs[appName]) == null ? void 0 : _a2.usageTime) || 0;
          return {
            ...prevLogs,
            [appName]: {
              appName,
              usageTime: prevUsage + Math.round(usageTime / 1e3),
              lastUsed: (/* @__PURE__ */ new Date()).toLocaleTimeString()
            }
          };
        });
      });
  ...
  reactExports.useEffect(() => {
    window.api.getHello().then((msg) => {
      setMessage(msg);
    });
  }, []);
  return /* @__PURE__ */ React.createElement("div", { style: { padding: "20px" } }, /* @__PURE__ */ React.createElement("h1", null, "Employee App Usage"), /* @__PURE__ */ React.createElement("table", { style: { width: "100%", borderCollapse: "collapse" } }, /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("th", { style: { border: "1px solid #ccc", padding: "8px" } }, "App Name"), /* @__PURE__ */ React.createElement("th", { style: { border: "1px solid #ccc", padding: "8px" } }, "Total Usage (seconds)"), /* @__PURE__ */ React.createElement("th", { style: { border: "1px solid #ccc", padding: "8px" } }, "Last Updated"))), /* @__PURE__ */ React.createElement("tbody", null, Object.values(appLogs).map((log) => /* @__PURE__ */ React.createElement("tr", { key: log.appName }, /* @__PURE__ */ React.createElement("td", { style: { border: "1px solid #ccc", padding: "8px" } }, log.appName), /* @__PURE__ */ React.createElement("td", { style: { border: "1px solid #ccc", padding: "8px" } }, log.usageTime), /* @__PURE__ */ React.createElement("td", { style: { border: "1px solid #ccc", padding: "8px" } }, log.lastUsed))))), /* @__PURE__ */ React.createElement("h1", null, message, "f"));
}
