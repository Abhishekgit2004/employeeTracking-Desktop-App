  ...
  reactExports.useEffect(() => {
    ...
    if ((_a = window.electronAPI) == null ? void 0 : _a.onActiveAppChange) {
      window.electronAPI.onActiveAppChange(({ appName, usageTime }) => {
        setAppLogs((prevLogs) => [
          ...prevLogs,
          { appName, usageTime: Math.round(usageTime / 1e3), timestamp: (/* @__PURE__ */ new Date()).toLocaleTimeString() }
        ]);
      });
    }
  }, []);
  return /* @__PURE__ */ React.createElement("div", { style: { padding: "20px" } }, /* @__PURE__ */ React.createElement("h1", null, "Employee App Usage"), /* @__PURE__ */ React.createElement("table", { style: { width: "100%", borderCollapse: "collapse" } }, /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("th", { style: { border: "1px solid #ccc", padding: "8px" } }, "Time"), /* @__PURE__ */ React.createElement("th", { style: { border: "1px solid #ccc", padding: "8px" } }, "App Name"), /* @__PURE__ */ React.createElement("th", { style: { border: "1px solid #ccc", padding: "8px" } }, "Usage (seconds)"))), /* @__PURE__ */ React.createElement("tbody", null, appLogs.map((log, index) => /* @__PURE__ */ React.createElement("tr", { key: index }, /* @__PURE__ */ React.createElement("td", { style: { border: "1px solid #ccc", padding: "8px" } }, log.timestamp), /* @__PURE__ */ React.createElement("td", { style: { border: "1px solid #ccc", padding: "8px" } }, log.appName), /* @__PURE__ */ React.createElement("td", { style: { border: "1px solid #ccc", padding: "8px" } }, log.usageTime))))));
}
